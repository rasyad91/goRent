...
var (
	...
	product3 = model.ElasticSearchProductSample{
		...
		Rating:      0,
		Description: "Legendary awesome racket",
		Price:       7.49,
		CreatedAt:   time.Now(),
		UpdatedAt:   time.Now(),
	...
	product4 = model.ElasticSearchProductSample{
		...
		Rating:      0,
		Description: "Renting out my beloved pair of skates as I no longer use them because of an new knee injury but dont wish to sell them because it carries sentimental values.",
		Price:       9.99,
		CreatedAt:   time.Now(),
		UpdatedAt:   time.Now(),
	...
	product8 = model.ElasticSearchProductSample{
		...
		Rating:      0,
		Description: "YThis printer is not just your run-of-the-mill printer. It is a monochrome printer. That means it doesnt just print in black and white. It also doesnt scream at you when you run out of red, green even when you do not use those colors",
		Price:       9.99,
		CreatedAt:   time.Now(),
		UpdatedAt:   time.Now(),
	...
	product13 = model.ElasticSearchProductSample{
		...
		Rating:      0,
		Description: "We recently had all the hockey sticks replaced for the entire team because of S.O.P that the management wanted. They are as good as new because we rarely used them. Very wasted to let them rot so we have deicded to rent them.",
		Price:       19.99,
		CreatedAt:   time.Now(),
		UpdatedAt:   time.Now(),
